...
const SingleCard = ({card, handleReadTime, handleBookmark}) => {
    const {blogCoverImage, authorImage, authorName, publishDate, readTimes, blogTitle, id} = card;
  return (
    <div>
      <div className="card">
        <img
        ...
        <a onClick={() => handleReadTime(readTimes)} className="read-more-btn">Mark as read</a>
        <hr />
      </div>
    </div>
  );
